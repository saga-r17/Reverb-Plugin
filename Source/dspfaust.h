...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "dspfaust.dsp");
		...
		m->declare("mi_lib_author", "Romain Michon");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("dspfaust");
