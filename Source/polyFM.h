/* ------------------------------------------------------------
name: "poly_fm_synth", "FaustDSP"
version: "2.54.11"
Code generated with Faust 2.54.9 (https://faust.grame.fr)
Compilation options: -a faustMinimalPoly.h -lang cpp -i -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("envelopes_lib_adsre_author", "Julius O. Smith III");
		m->declare("envelopes_lib_adsre_licence", "STK-4.3");
		...
		m->declare("fds_lib_author", "Romain Michon");
		m->declare("fds_lib_name", "Faust Finite Difference Schemes Library");
		m->declare("fds_lib_version", "0.0");
		m->declare("filename", "poly_fm_synth.dsp");
		...
		m->declare("hoa_lib_copyright", "2012-2013 Guillot, Paris, Colafrancesco, CICM labex art H2H, U. Paris 8, 2019 Wargreen, 2022 Bonardi, Goutmann");
		m->declare("hoa_lib_name", "High Order Ambisonics library");
		m->declare("hoa_lib_version", "0.4");
		m->declare("interpolators_lib_name", "Faust Interpolator Library");
		m->declare("interpolators_lib_version", "0.3");
		m->declare("library_path0", "/libraries/all.lib");
		m->declare("library_path1", "/libraries/webaudio.lib");
		m->declare("library_path10", "/libraries/reverbs.lib");
		m->declare("library_path11", "/libraries/reducemaps.lib");
		m->declare("library_path12", "/libraries/quantizers.lib");
		m->declare("library_path13", "/libraries/physmodels.lib");
		m->declare("library_path14", "/libraries/stdfaust.lib");
		m->declare("library_path15", "/libraries/phaflangers.lib");
		m->declare("library_path16", "/libraries/noises.lib");
		m->declare("library_path17", "/libraries/oscillators.lib");
		m->declare("library_path18", "/libraries/misceffects.lib");
		m->declare("library_path19", "/libraries/mi.lib");
		m->declare("library_path2", "/libraries/wdmodels.lib");
		m->declare("library_path20", "/libraries/maths.lib");
		m->declare("library_path21", "/libraries/interpolators.lib");
		m->declare("library_path22", "/libraries/hoa.lib");
		m->declare("library_path23", "/libraries/filters.lib");
		m->declare("library_path24", "/libraries/fds.lib");
		m->declare("library_path25", "/libraries/envelopes.lib");
		m->declare("library_path26", "/libraries/dx7.lib");
		m->declare("library_path27", "/libraries/demos.lib");
		m->declare("library_path28", "/libraries/delays.lib");
		m->declare("library_path29", "/libraries/compressors.lib");
		m->declare("library_path3", "/libraries/version.lib");
		m->declare("library_path30", "/libraries/basics.lib");
		m->declare("library_path31", "/libraries/analyzers.lib");
		m->declare("library_path32", "/libraries/aanl.lib");
		m->declare("library_path33", "/libraries/platform.lib");
		m->declare("library_path4", "/libraries/vaeffects.lib");
		m->declare("library_path5", "/libraries/synths.lib");
		m->declare("library_path6", "/libraries/spats.lib");
		m->declare("library_path7", "/libraries/soundfiles.lib");
		m->declare("library_path8", "/libraries/signals.lib");
		...
		m->declare("mi_lib_author", "James Leonard");
		m->declare("mi_lib_copyright", "2018-2020 GRAME / GIPSA-Lab");
		m->declare("mi_lib_name", "Faust mass-interaction physical modelling library");
		m->declare("mi_lib_version", "0.0");
		m->declare("misceffects_lib_name", "Misc Effects Library");
		m->declare("misceffects_lib_version", "2.0");
		m->declare("name", "poly_fm_synth");
		...
		m->declare("phaflangers_lib_version", "0.1");
		...
		m->declare("quantizers_lib_name", "Faust Frequency Quantization Library");
		m->declare("quantizers_lib_version", "0.1");
		m->declare("reducemaps_lib_author", "Yann Orlarey (orlarey at grame.fr)");
		m->declare("reducemaps_lib_copyright", "Grame");
		m->declare("reducemaps_lib_license", "LGPL with exception");
		m->declare("reducemaps_lib_name", "Reduce Library");
		m->declare("reducemaps_lib_version", "0.1");
		...
		m->declare("soundfiles_lib_version", "0.7");
		...
		m->declare("synths_lib_version", "0.1");
		...
		m->declare("wdmodels_lib_name", "Faust Wave Digital Model Library");
		m->declare("wdmodels_lib_version", "0.2.1");
		m->declare("webaudio_lib_author", "GRAME");
		m->declare("webaudio_lib_copyright", "GRAME");
		m->declare("webaudio_lib_license", "LGPL with exception");
		m->declare("webaudio_lib_name", "Faust WebAudio Filters Library");
		m->declare("webaudio_lib_version", "0.1");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("poly_fm_synth");
		ui_interface->addHorizontalSlider("Attack", &fHslider4, FAUSTFLOAT(0.01f), FAUSTFLOAT(0.01f), FAUSTFLOAT(4.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("Decay", &fHslider5, FAUSTFLOAT(0.6f), FAUSTFLOAT(0.01f), FAUSTFLOAT(8.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("Release", &fHslider3, FAUSTFLOAT(0.6f), FAUSTFLOAT(0.01f), FAUSTFLOAT(8.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("Sustain", &fHslider6, FAUSTFLOAT(0.2f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("bend", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(-2.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->addNumEntry("midi_frequency", &fEntry0, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("midi_gain", &fEntry1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addButton("midi_gate", &fButton0);
		ui_interface->addHorizontalSlider("mod_ratio", &fHslider0, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("modulation", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow10 = float(fHslider6) * fSlow9;
		float fSlow11 = 1e+03f * float(fEntry1);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec4[0] = fSlow0 + fConst2 * fRec4[1];
			fRec5[0] = fSlow2 + fConst2 * fRec5[1];
			float fTemp0 = fRec3[1] + fConst3 * (fSlow3 * fRec5[0] * fRec2[1] + fSlow1 * fRec4[0]);
			fRec3[0] = fTemp0 - std::floor(fTemp0);
			float fTemp1 = 65536.0f * fRec3[0];
			int iTemp2 = int(fTemp1);
			float fTemp3 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp2, 65536))];
			fRec2[0] = fTemp3 + (fTemp1 - std::floor(fTemp1)) * (ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp2 + 1, 65536))] - fTemp3);
			iVec1[0] = iSlow4;
			int iTemp4 = iSlow4 - iVec1[1];
			iRec7[0] = iSlow4 * (iRec7[1] + 1);
			int iTemp5 = (iRec7[0] < iSlow7) | (iTemp4 * (iTemp4 > 0));
			float fTemp6 = 0.1447178f * ((iSlow4) ? ((iTemp5) ? fSlow6 : fSlow8) : fSlow5);
			int iTemp7 = std::fabs(fTemp6) < 1.1920929e-07f;
			float fTemp8 = ((iTemp7) ? 0.0f : std::exp(0.0f - fConst3 / ((iTemp7) ? 1.0f : fTemp6)));
			fRec6[0] = (1.0f - fTemp8) * ((iSlow4) ? ((iTemp5) ? fSlow9 : fSlow10) : 0.0f) + fTemp8 * fRec6[1];
			float fTemp9 = fRec1[1] + fConst3 * (fSlow1 + fSlow11 * fRec6[0] * fRec2[0]);
			fRec1[0] = fTemp9 - std::floor(fTemp9);
			float fTemp10 = 65536.0f * fRec1[0];
			int iTemp11 = int(fTemp10);
			float fTemp12 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp11, 65536))];
			float fTemp13 = fRec6[0] * (fTemp12 + (fTemp10 - std::floor(fTemp10)) * (ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iTemp11 + 1, 65536))] - fTemp12));
